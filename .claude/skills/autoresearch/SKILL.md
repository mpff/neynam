...
(MIT). Read this end-to-end before touching anything. Project-specific
placeholders (`train.py`, `prepare.py`, `val_bpb`, the 5-minute budget,
`~/.cache/autoresearch/`) need to be mapped onto the current repo
*before* kicking off the loop — confirm the mapping with the user once,
then proceed.
